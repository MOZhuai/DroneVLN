...
def draw_drone_poses(drone_poses):
    ...
    poses_map = poses_as_to_img(drone_poses, 128, batch_dim=True)
...
def save_tensor_as_img(tensor, name, env_id, seg_idx=None, renorm_each_channel=False):
    ...
    imwrite(get_viz_dir(env_id, seg_idx) + name + ".png", tensor)