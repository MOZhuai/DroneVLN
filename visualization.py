...
class Presenter:
    ...
    def plot_paths(self, segment_dataset, segment_path=None, file=None, interactive=False, bg=True, texts=[], entire_trajectory=False):
        ...
        # x_pvn = [944.04640198, 937.58157094, 933.69878133, 916.54370626, 910.1764679, 887.95808156, 880.77176412,
        #          854.83557383, 849.80297089, 823.81833394, 818.65857442]
        #
        # y_pvn = [418.94219716, 427.49900818, 432.58870443, 453.19633484, 460.3187561, 483.55747859, 490.69163005,
        #          515.99143346, 520.88158925, 546.24783198, 551.31139755]
        # x_pvn = np.asarray(x_pvn)
        # y_pvn = np.asarray(y_pvn)
        # plt.plot(x_pvn, y_pvn, "yellow")
        # plt.plot(x_pvn[-1], y_pvn[-1], color="yellow", marker='o')
        ...
        plt.plot(x_actual[-1], y_actual[-1], color="blue", marker='o')
